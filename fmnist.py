...
def main():
    ...
    ### FashionMNIST download url: https://github.com/zalandoresearch/fashion-mnist/tree/master/data/fashion ###
    train_loader = torch.utils.data.DataLoader(
        datasets.FashionMNIST("/home/lip/LiPan/data", train=True, download=True,
    ...
    test_loader = torch.utils.data.DataLoader(
        datasets.FashionMNIST("/home/lip/LiPan/data", train=False, transform=transforms.Compose([
            transforms.ToTensor(),
            transforms.Normalize((0.1307,), (0.3081,))
        ])),
